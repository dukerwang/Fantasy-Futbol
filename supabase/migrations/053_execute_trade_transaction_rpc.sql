-- ============================================================
-- Migration 053: Atomic Trade Transaction Execution RPC
-- ============================================================

-- Add accepted_deferred value to trade_proposal_status enum
ALTER TYPE public.trade_proposal_status ADD VALUE IF NOT EXISTS 'accepted_deferred';
