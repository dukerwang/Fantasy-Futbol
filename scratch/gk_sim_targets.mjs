...
async function main() {
  ...
  const strategies = [
    { name: '1. Baseline V2', params: { saveFloorOnCS: 0, csBonus: 12, baseWeights: { match_impact: 0.25, influence: 0.20, defensive: 0.20, save_score: 0.15 } } },
    { name: '2. CS Floor 0.50', params: { saveFloorOnCS: 0.50, csBonus: 12, baseWeights: { match_impact: 0.25, influence: 0.20, defensive: 0.20, save_score: 0.15 } } },
    { name: '3. CS Floor 0.70', params: { saveFloorOnCS: 0.70, csBonus: 12, baseWeights: { match_impact: 0.25, influence: 0.20, defensive: 0.20, save_score: 0.15 } } },
    { name: '4. Weight Realignment (Def 0.25, Save 0.10)', params: { saveFloorOnCS: 0, csBonus: 12, baseWeights: { match_impact: 0.25, influence: 0.20, defensive: 0.25, save_score: 0.10 } } },
    { name: '5. CS Floor 0.70 + Realignment', params: { saveFloorOnCS: 0.70, csBonus: 12, baseWeights: { match_impact: 0.25, influence: 0.20, defensive: 0.25, save_score: 0.10 } } },
    { name: '6. CS Bonus 18', params: { saveFloorOnCS: 0, csBonus: 18, baseWeights: { match_impact: 0.25, influence: 0.20, defensive: 0.20, save_score: 0.15 } } },
    { name: '7. CS Floor 0.70 + CS Bonus 18', params: { saveFloorOnCS: 0.70, csBonus: 18, baseWeights: { match_impact: 0.25, influence: 0.20, defensive: 0.20, save_score: 0.15 } } },
    { name: '8. CS Floor 0.70 + CS Bonus 18 + Realignment', params: { saveFloorOnCS: 0.70, csBonus: 18, baseWeights: { match_impact: 0.25, influence: 0.20, defensive: 0.25, save_score: 0.10 } } },
  ];
  ...
  console.log('\n--- TARGET GOALKEEPERS COMPARATIVE PPG MATRIX ---');
