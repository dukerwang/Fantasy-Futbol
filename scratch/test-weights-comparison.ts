...
// Choice 1: Proposed Plan Option C (defensive = 0.25, influence = 0.10)
const WEIGHTS_CHOICE_1 = {
...
// Choice 2: Balanced Weights (defensive = 0.15, influence = 0.20)
const WEIGHTS_CHOICE_2 = {
  ...
  CM: { match_impact: 0.25, influence: 0.10, creativity: 0.15, threat: 0.00, defensive: 0.15, goal_involvement: 0.10, finishing: 0.00, save_score: 0.00 }
};
...
(async () => {
  ...
  const choices = [
    { name: "Choice 1 (defensive = 0.25, influence = 0.10, xgcMult = 2.0)", weights: WEIGHTS_CHOICE_1, xgcMult: 2.0 },
    { name: "Choice 2 (defensive = 0.15, influence = 0.20, xgcMult = 2.0)", weights: WEIGHTS_CHOICE_2, xgcMult: 2.0 },
    { name: "Choice 3 (defensive = 0.15, influence = 0.20, xgcMult = 1.5)", weights: WEIGHTS_CHOICE_2, xgcMult: 1.5 },
  ];
  ...
  for (const c of choices) {
    ...
    for (const item of players) {
      ...
      for (const r of statsRows) {
        ...
        const res = calculateRating(enrichedStats, pos, refStats, c.weights[pos], c.xgcMult);
