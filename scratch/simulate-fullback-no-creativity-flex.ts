...
const CONFIGS = [
  {
    name: 'Current V2 (Creativity in Flex)',
    weights: {
  ...
  {
    name: 'Tweak A (Remove Creativity from Flex - Only Match Impact & Defensive)',
    weights: {
      match_impact: 0.25, influence: 0.15, creativity: 0.15, threat: 0.00, defensive: 0.15, goal_involvement: 0.05, finishing: 0.00, save_score: 0.00
    },
    flexComponents: ['match_impact', 'defensive'],
  }
];
...
function simulateMatchRating(
  ...
  return {
    ...
    fantasyPoints: Math.max(0, finalPoints)
  };
}
