...
const FLEX_CONFIG = {
  ...
  CB: { flex: 0.25, components: ['defensive', 'match_impact', 'threat'] },
  LB: { flex: 0.20, components: ['defensive', 'match_impact', 'creativity'] },
  RB: { flex: 0.20, components: ['defensive', 'match_impact', 'creativity'] },
  DM: { flex: 0.20, components: ['defensive', 'influence', 'match_impact'] },
  CM: { flex: 0.20, components: ['match_impact', 'creativity', 'influence'] },
  LM: { flex: 0.20, components: ['influence', 'creativity', 'threat'] },
  RM: { flex: 0.20, components: ['influence', 'creativity', 'threat'] },
  AM: { flex: 0.25, components: ['influence', 'creativity', 'goal_involvement'] },
  LW: { flex: 0.25, components: ['creativity', 'threat', 'goal_involvement'] },
  RW: { flex: 0.25, components: ['creativity', 'threat', 'goal_involvement'] },
  ST: { flex: 0.25, components: ['threat', 'goal_involvement', 'finishing'] },
};

const POSITION_WEIGHTS = {
  GK: { match_impact: 0.25, influence: 0.20, creativity: 0.05, threat: 0.00, defensive: 0.20, goal_involvement: 0.00, finishing: 0.00, save_score: 0.10 },
  CB: { match_impact: 0.20, influence: 0.15, creativity: 0.05, threat: 0.00, defensive: 0.25, goal_involvement: 0.05, finishing: 0.05, save_score: 0.00 },
  LB: { match_impact: 0.20, influence: 0.20, creativity: 0.05, threat: 0.05, defensive: 0.15, goal_involvement: 0.10, finishing: 0.05, save_score: 0.00 },
  RB: { match_impact: 0.20, influence: 0.20, creativity: 0.05, threat: 0.05, defensive: 0.15, goal_involvement: 0.10, finishing: 0.05, save_score: 0.00 },
  DM: { match_impact: 0.25, influence: 0.20, creativity: 0.10, threat: 0.00, defensive: 0.15, goal_involvement: 0.05, finishing: 0.05, save_score: 0.00 },
  CM: { match_impact: 0.15, influence: 0.15, creativity: 0.15, threat: 0.10, defensive: 0.10, goal_involvement: 0.10, finishing: 0.05, save_score: 0.00 },
  LM: { match_impact: 0.15, influence: 0.15, creativity: 0.15, threat: 0.10, defensive: 0.10, goal_involvement: 0.10, finishing: 0.05, save_score: 0.00 },
  RM: { match_impact: 0.15, influence: 0.15, creativity: 0.15, threat: 0.10, defensive: 0.10, goal_involvement: 0.10, finishing: 0.05, save_score: 0.00 },
  AM: { match_impact: 0.10, influence: 0.15, creativity: 0.15, threat: 0.15, defensive: 0.00, goal_involvement: 0.15, finishing: 0.05, save_score: 0.00 },
  LW: { match_impact: 0.10, influence: 0.15, creativity: 0.05, threat: 0.20, defensive: 0.00, goal_involvement: 0.15, finishing: 0.10, save_score: 0.00 },
  RW: { match_impact: 0.10, influence: 0.15, creativity: 0.05, threat: 0.20, defensive: 0.00, goal_involvement: 0.15, finishing: 0.10, save_score: 0.00 },
  ST: { match_impact: 0.10, influence: 0.10, creativity: 0.05, threat: 0.20, defensive: 0.00, goal_involvement: 0.15, finishing: 0.15, save_score: 0.00 },
};
...
// Default reference stats — granular per-position (from edge function DEFAULT_REF)
const DEFAULT_REF = {
...
function computeMatchRating(stats, position, refStats) {
  ...
  // 5. Defensive (includes tackles/CBI/recoveries — matches edge function exactly)
  ...
  if (stats.id === 235 && stats.goals === 1) console.log("PALMER (1 Goal):", JSON.stringify(scores, null, 2), "maxComponent:", maxComponent, "weights:", weights);
if (stats.id === 98 && stats.goals === 1) console.log("SEMENYO (1 Goal):", JSON.stringify(scores, null, 2), "maxComponent:", maxComponent, "weights:", weights);
for (const [key, weight] of Object.entries(weights)) {
  ...
  if ((stats.id === 235 || stats.id === 98) && stats.goals === 1) console.log("FINAL COMPOSITE:", composite);
...
async function main() {
  ...
  for (const gw of finishedGWs) {
    ...
    for (const el of elements) {
      ...
      const stats = {
        ...
        // Granular defensive stats (key addition — missing from old script)
  ...
  console.log('\n── Top 20 by Avg Points Per Game (min 10 GW) ─────────────────');
  console.log('Rank  Player              Team  Pos    GP    Pts     Avg');
  console.log('─'.repeat(65));
  for (let i = 0; i < Math.min(20, consistent.length); i++) {
