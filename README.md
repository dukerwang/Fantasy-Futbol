...
- **Granular Position Enforcement**: 12 distinct positions (GK, CB, LB, RB, LWB, RWB, DM, CM, AM, LW, RW, ST) are strictly enforced in roster validation, lineup setting, and scoring weights.
